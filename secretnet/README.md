...
Небольшая ремарка - как видно из изображения, пользователь `ivanov` имеет ограничения на уровне каталога "КТ_", а не файла как требуется в задании, файл же наследует уровень конфденциальности, что соответствует принципам  полномочного  управления доступом.
